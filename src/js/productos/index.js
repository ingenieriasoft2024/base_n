...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/base_n/API/producto/guardar"
        const config = {
            method: 'POST',
            body
        }
...
const buscar = async () => {
    try {
        const url = "/base_n/API/producto/buscar"
        const config = {
            method: 'GET',
        }
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = "/base_n/API/producto/modificar"
        const config = {
            method: 'POST',
            body
        }
...
const eliminar = async (producto) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/base_n/API/producto/eliminar"
            const config = {
                method: 'POST',
                body
            }
